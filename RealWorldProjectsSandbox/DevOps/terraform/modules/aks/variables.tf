...
variable "cluster_name" {
  description = "(Required) The name for the AKS resources created in the specified Azure Resource Group."
  type        = string
}
...
variable "system_pool_count" {
  description = "The number of system nodes that should exist in the Agent Pool. Please set `system_pool_count` `null` while `enable_auto_scaling` is `true` to avoid possible `system_pool_count` changes."
  type        = number
  default     = 2
}
...
variable "workload_pool_node_max_count" {
  type        = number
  description = "Maximum number of nodes in a pool"
  default     = null
}

variable "workload_pool_node_min_count" {
  type        = number
  description = "Minimum number of nodes in a pool"
  default     = null
}
...
variable "workload_pool_name" {
  description = "The workload Azure AKS agentpool (nodepool) name."
  type        = string
  default     = "linux"
}
...
variable "system_pool_labels" {
  description = "(Optional) A map of Kubernetes labels which should be applied to nodes in the Default Node Pool. Changing this forces a new resource to be created."
  type        = map(string)
  default     = {}
}

variable "workload_pool_labels" {
  description = "(Optional) A map of Kubernetes labels which should be applied to nodes in the Default Node Pool. Changing this forces a new resource to be created."
  type        = map(string)
  default     = {}
}
...
variable "private_dns_zone_id" {
  description = "the private dns zone to bound with this cluser."
  type        = string
  default     = null
}
