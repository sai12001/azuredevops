...
sql_mi = {
  instance_name                = "tbs"
  resource_group               = "stg-rg-ng-tbs-sql"
...
# databricks config
databricks = {
  databricks_workspace_name = "stg-ng-databricks-wspace"
  databricks_sku            = "premium"
  storage_account_sku_name  = "Standard_GRS"
  resource_group            = "stg-rg-ng-databricks-eau"
  private_subnet_name       = "subnet-databricks-containers"
  public_subnet_name        = "subnet-databricks-host"
  driver_node_type_id       = "Standard_DS3_v2"
  spark_version             = "10.4.x-scala2.12"
  vnet_name                 = "stg-vnet-ng-shared-eau"
  vnet_resource_group       = "stg-rg-ng-infra-shared-eau"
  ...
  network_security_group_rules = [
    {
      ...
      source_address_prefix      = "10.4.23.0/25"
...
powerbi = {
  sku_name       = "A1"
  resource_group = "stg-rg-ng-powerbi-eau"
