...
stg_management_group_id     = "/providers/Microsoft.Management/managementgroups/mg-blackstream-stg"
...
vnet = {
  name          = "stg-vnet-ng-shared-eau"
  address_space = ["10.4.16.0/20"]
  subnets = [
    {
      name              = "AzureFirewallSubnet"
      prefixes          = ["10.4.16.0/24"]
      service_endpoints = []
    },
    {
      name              = "subnet-privatelinks"
      prefixes          = ["10.4.17.0/24"]
...
enable_ntrc = true
vnet_ntrc = {
  name          = "stg-vnet-ng-ntrc-eau"
  address_space = ["10.4.244.0/22"]
  subnets = [
    {
      name     = "subnet-db"
      prefixes = ["10.4.244.0/26"]
      delegation = {
        name = "Microsoft.Sql.managedInstances"
        service_delegation = {
          name = "Microsoft.Sql/managedInstances"
...
#Diagnostic Settings
#Staging LogAnalytics Workspace
log_analytics_name                        = "stg-logs-ng-workspace-eau"
log_analytics_rg_name                     = "stg-rg-ng-infra-shared-eau"
log_analytics_workspace_id                = "/subscriptions/7b12ad1c-8c8d-45b7-ba98-4a5ebcc14576/resourcegroups/stg-rg-ng-infra-shared-eau/providers/microsoft.operationalinsights/workspaces/stg-logs-ng-workspace-eau"
